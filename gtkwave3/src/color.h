...
#define WAVE_COLOR_CYAN (5)
#define WAVE_COLOR_VIOLET (6)
#define WAVE_COLOR_MAGENTA (7)

#define WAVE_NUM_RAINBOW (7)

#define WAVE_RAINBOW_RGB {0xFF5050, 0xFF7F00, 0xFFFF00, 0x00FF00, 0x00FFFF, 0xB380FF, 0xFF00FF}
